...
> [!IMPORTANT]
> このリポジトリは[上流の CC Switch](https://github.com/farion1231/cc-switch)を基に、Codex のマルチプロバイダーモデルルーティングを追加したコミュニティフォークです。上流の公式リリースではなく、上流のスポンサーはこのフォークを支援または推奨していません。
