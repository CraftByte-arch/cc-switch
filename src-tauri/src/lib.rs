...
pub fn run() {
    ...
    let builder = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::edit_codex_routing_provider,
            ...
            commands::get_codex_native_routing_provider,
            commands::start_codex_native_login,
            commands::get_codex_native_login_status,
            commands::cancel_codex_native_login,
