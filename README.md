...
> [!IMPORTANT]
> This is a community fork of [CC Switch](https://github.com/farion1231/cc-switch), focused on Codex multi-provider model routing. It is not an official upstream release, and upstream sponsors do not sponsor or endorse this fork.
